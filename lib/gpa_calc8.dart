...
import 'dart:async';
class GPAcalc8 extends StatefulWidget {
  final int n8;

  GPAcalc8(this.n8);

  @override
  GPAcalcstate8 createState() => new GPAcalcstate8();
}

class GPAcalcstate8 extends State<GPAcalc8> {
  List<String> _items = ['O', 'A+', 'A', 'B+', 'B',  'RA'].toList();
  List<String> _itemsCp = ['1', '2', '3', '4', '5' , '10'].toList();
  var _selection;
  var _selectionCp;
  var list;
  ...
  void initState() {
    super.initState();
    _selection= new List<String>()..length=widget.n8;
    _selectionCp= new List<String>()..length=widget.n8;
    list = new List<int>.generate(widget.n8, (i) =>i);
  }
          ...
          if(safeToNavigate)
            Navigator.of(context).pushReplacement(
              new MaterialPageRoute(
                builder: (BuildContext context) => new GPA8(res8),
              ),
            );
          else{
            alert();
