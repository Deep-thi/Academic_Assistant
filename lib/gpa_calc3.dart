...
import 'dart:async';
class GPAcalc3 extends StatefulWidget {
  final int n3;

  GPAcalc3(this.n3);

  @override
  GPAcalcstate3 createState() => new GPAcalcstate3();
}

class GPAcalcstate3 extends State<GPAcalc3> {
  ...
  void initState() {
    super.initState();
    _selection= new List<String>()..length=widget.n3;
    _selectionCp= new List<String>()..length=widget.n3;
    list = new List<int>.generate(widget.n3, (i) =>i);
  }
          ...
          if(safeToNavigate)
            Navigator.of(context).pushReplacement(
              new MaterialPageRoute(
                builder: (BuildContext context) => new GPA3(res3),
              ),
            );
          else{
            alert();
