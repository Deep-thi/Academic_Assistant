...
import 'dart:async';
class GPAcalc5 extends StatefulWidget {
  final int n5;

  GPAcalc5(this.n5);

  @override
  GPAcalcstate5 createState() => new GPAcalcstate5();
}

class GPAcalcstate5 extends State<GPAcalc5> {
  ...
  void initState() {
    super.initState();
    _selection= new List<String>()..length=widget.n5;
    _selectionCp= new List<String>()..length=widget.n5;
    list = new List<int>.generate(widget.n5, (i) =>i);
  }
          ...
          if(safeToNavigate)
            Navigator.of(context).pushReplacement(
              new MaterialPageRoute(
                builder: (BuildContext context) => new GPA5(res5),
              ),
            );
          else{
            alert();
