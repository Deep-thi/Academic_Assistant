...
import 'dart:async';
class GPAcalc7 extends StatefulWidget {
  final int n7;

  GPAcalc7(this.n7);

  @override
  GPAcalcstate7 createState() => new GPAcalcstate7();
}

class GPAcalcstate7 extends State<GPAcalc7> {
  ...
  void initState() {
    super.initState();
    _selection= new List<String>()..length=widget.n7;
    _selectionCp= new List<String>()..length=widget.n7;
    list = new List<int>.generate(widget.n7, (i) =>i);
  }
          ...
          if(safeToNavigate)
            Navigator.of(context).pushReplacement(
              new MaterialPageRoute(
                builder: (BuildContext context) => new GPA7(res7),
              ),
            );
          else{
            alert();
