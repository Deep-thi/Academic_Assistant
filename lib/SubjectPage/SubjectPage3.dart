import 'package:academic_assistant/Marks/Marks3.dart';
import 'package:flutter/material.dart';
import 'package:academic_assistant/todo_main.dart';
import 'package:academic_assistant/Attendance/Attendance3.dart';


class SubjectPage3 extends StatefulWidget {
  @override
  _MyBottomBarDemoState createState() => new _MyBottomBarDemoState();
}

class _MyBottomBarDemoState extends State<SubjectPage3> {
  int _pageIndex = 0;
