import 'package:academic_assistant/Marks/Marks8.dart';
import 'package:flutter/material.dart';
import 'package:academic_assistant/todo_main.dart';
import 'package:academic_assistant/Attendance/Attendance8.dart';


class SubjectPage8 extends StatefulWidget {
  @override
  _MyBottomBarDemoState createState() => new _MyBottomBarDemoState();
}

class _MyBottomBarDemoState extends State<SubjectPage8> {
  int _pageIndex = 0;
