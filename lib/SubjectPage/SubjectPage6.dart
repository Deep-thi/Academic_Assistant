import 'package:academic_assistant/Marks/Marks6.dart';
import 'package:flutter/material.dart';
import 'package:academic_assistant/todo_main.dart';
import 'package:academic_assistant/Attendance/Attendance6.dart';


class SubjectPage6 extends StatefulWidget {
  @override
  _MyBottomBarDemoState createState() => new _MyBottomBarDemoState();
}

class _MyBottomBarDemoState extends State<SubjectPage6> {
  int _pageIndex = 0;
