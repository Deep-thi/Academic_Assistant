...
import 'dart:async';
class GPAcalc4 extends StatefulWidget {
  final int n4;

  GPAcalc4(this.n4);

  @override
  GPAcalcstate4 createState() => new GPAcalcstate4();
}

class GPAcalcstate4 extends State<GPAcalc4> {
  ...
  void initState() {
    super.initState();
    _selection= new List<String>()..length=widget.n4;
    _selectionCp= new List<String>()..length=widget.n4;
    list = new List<int>.generate(widget.n4, (i) =>i);
  }
          ...
          if(safeToNavigate)
            Navigator.of(context).pushReplacement(
              new MaterialPageRoute(
                builder: (BuildContext context) => new GPA4(res4),
              ),
            );
          else{
            alert();
