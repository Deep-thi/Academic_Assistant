...
import 'dart:async';
class GPAcalc2 extends StatefulWidget {
  final int n2;

  GPAcalc2(this.n2);

  @override
  GPAcalcstate2 createState() => new GPAcalcstate2();
}

class GPAcalcstate2 extends State<GPAcalc2> {
  ...
  void initState() {
    super.initState();
    _selection= new List<String>()..length=widget.n2;
    _selectionCp= new List<String>()..length=widget.n2;
    list = new List<int>.generate(widget.n2, (i) =>i);
  }
          ...
          if(safeToNavigate)
            Navigator.of(context).pushReplacement(
              new MaterialPageRoute(
                builder: (BuildContext context) => new GPA2(res2),
              ),
            );
          else{
            alert();
