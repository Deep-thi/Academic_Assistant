...
class NumericTextFieldWidget6 extends State {
  ...
  String titlea16 = "Enter Assessment 1 marks";
  String titlea26 = "Enter Assessment 2 marks";
  ...
  void init() async {
    ...
    titlea16 = (pref6.getString('titlea16') ?? "Enter Assessment 1 marks");
    titlea26 = (pref6.getString('titlea26') ?? "Enter Assessment 2 marks");
