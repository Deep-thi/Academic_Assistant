...
class NumericTextFieldWidget1 extends State {
  ...
  String titlea11 = "Enter Assessment 1 marks";
  String titlea21 = "Enter Assessment 2 marks";
  ...
  void init() async {
    ...
    titlea11 = (pref1.getString('titlea11') ?? "Enter Assessment 1 marks");
    titlea21 = (pref1.getString('titlea21') ?? "Enter Assessment 2 marks");
