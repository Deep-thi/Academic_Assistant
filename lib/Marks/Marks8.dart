...
class NumericTextFieldWidget8 extends State {
  ...
  String titlea18 = "Enter Assessment 1 marks";
  String titlea28 = "Enter Assessment 2 marks";
  ...
  void init() async {
    ...
    titlea18 = (pref8.getString('titlea18') ?? "Enter Assessment 1 marks");
    titlea28 = (pref8.getString('titlea28') ?? "Enter Assessment 2 marks");
